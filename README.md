...
3. "tidydataset.csv" : The first cleaned data file with extracts of only the measurements on the mean and standard deviation for each measurement, and with descriptive activity names to name the activities in the data set 
4. "tidydataset2.csv" The second cleaned data file with the average of each variable for each activity and each subject.
